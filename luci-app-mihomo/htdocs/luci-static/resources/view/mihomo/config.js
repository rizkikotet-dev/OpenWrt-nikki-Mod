...
return view.extend({
  ...
  render: function (data) {
    ...
    m = new form.Map(
      "mihomo",
      _(
        '<p><strong><span style="color: rgb(41, 105, 176);">✦ Mihomo</span> <span style="color: rgb(250, 197, 28);">TProxy ✦</span></strong></p>'
      ),
      `${_(
        "Transparent Proxy with Mihomo on OpenWrt."
      )} <a href="https://github.com/morytyann/OpenWrt-mihomo/wiki" target="_blank">${_(
        "How To Use"
      )}</a>`
    );
    ...
    s = m.section(
      ...
      "config",
      "config",
      _("<p><strong>⚙️ Basic Config</strong></p>")
    );
    ...
    o = s.taboption(
      "core_env",
      form.Flag,
      "disable_safe_path_check",
      _("Disable Safe Path Check")
    );
    o.ucisection = "env";
    o.rmempty = false;
    ...
    s = m.section(
      ...
      "proxy",
      "proxy",
      _("<p><strong>🔧 Proxy Config</strong></p>")
    );
    ...
    o = s.taboption(
      ...
      form.Value,
      "proxy_tcp_dport",
      _("Destination TCP Port to Proxy")
    );
    o.rmempty = false;
    o.value("0-65535", _("All Port"));
    o.value(
      "21 22 80 110 143 194 443 465 853 993 995 8080 8443",
      _("Commonly Used Port")
    );
    ...
    o = s.taboption(
      ...
      form.Value,
      "proxy_udp_dport",
      _("Destination UDP Port to Proxy")
    );
    o.rmempty = false;
    o.value("0-65535", _("All Port"));
    ...
    s = m.section(
      form.GridSection,
      "subscription",
      _("<p><strong>💾 Subscription Config</strong></p>")
    );
    s.addremove = true;
    s.anonymous = true;
    s.sortable = true;
    ...
    o.rmempty = false;
    o.value(
      "https://ghp.ci/https://github.com/MetaCubeX/metacubexd/archive/refs/heads/gh-pages.zip",
      "MetaCubeXD"
    );
    o.value(
      "https://ghp.ci/https://github.com/MetaCubeX/Yacd-meta/archive/refs/heads/gh-pages.zip",
      "YACD"
    );
    o.value(
      "https://ghp.ci/https://github.com/MetaCubeX/Razord-meta/archive/refs/heads/gh-pages.zip",
      "Razord"
    );
    o.value(
      "https://ghp.ci/https://github.com/Zephyruso/zashboard/archive/refs/heads/gh-pages.zip",
      "Zashboard"
    );
