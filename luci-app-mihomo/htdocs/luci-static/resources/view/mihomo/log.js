...
return view.extend({
  ...
  render: function (data) {
    ...
    o.onclick = function () {
      const element = m
        .lookupOption("mihomo.log._app_log")[0]
        .getUIElement("log").node.firstChild;
    ...
    o.inputtitle = _("Clear Log");
    o.onclick = function () {
      m.lookupOption("mihomo.log._core_log")[0]
        .getUIElement("log")
        .setValue("");
    ...
    o.onclick = function () {
      const element = m
        .lookupOption("mihomo.log._core_log")[0]
        .getUIElement("log").node.firstChild;
      element.scrollTop = element.scrollHeight;
    };
